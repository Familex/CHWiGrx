...
LRESULT CALLBACK figures_list_wndproc(const HWND h_wnd, const UINT message, const WPARAM w_param, const LPARAM l_param) {
    ...
    switch (message) {
        ...
        case WM_HSCROLL:
        {
            ...
            SetWindowPos(h_wnd, nullptr, NULL, NULL,
        ...
        case WM_VSCROLL:
        {
            ...
            ScrollWindowEx(h_wnd, 0, -delta, nullptr,
        ...
        case WM_GETMINMAXINFO:
        {
            ...
            lp_mmi->ptMaxTrackSize.y = static_cast<int>(figures_list.get_all_figures_height()) + HEADER_HEIGHT - SCROLLBAR_THICKNESS;
        }
        break;
        case WM_PAINT:
        {
            ...
            /* фон */
            const RECT full_rect = { .left = prect->left, .top = prect->top + curr_scroll,
            ...
            for (std::size_t index = 0; index < figures_prototypes[curr_color].size(); ++index) {
                ...
                draw_figure(hdc_mem, fig_to_draw.get(), Pos{x, y},
        ...
        case WM_LBUTTONDOWN:
        {
            ...
            const Pos figure_to_drag = Pos(
                (LOWORD(l_param)) / static_cast<int>(figures_list.get_cell_width()),
                (HIWORD(l_param) + figures_list.get_curr_scroll()) / static_cast<int>(figures_list.get_cell_width())
            ).change_axes();
