...
inline const auto DEFAULT_CHESS_BOARD_IDW{ 
    from_string<board_repr::BoardRepr>{}(
        "02H8W8TWC0,7,25,32!"
        "0.00BR1.01BK2.02BB3.03BK4.04BQ5.05BB6.06BK7.07BR8.08BP9.09BP10.10BP11.11BP13.12BP14.13BP15.14BP16.15BP17.48WP18.49WP19.50WP20.51WP21.52WP22.53WP23.54WP24.55WP25.56WR26.57WK27.58WB28.59WK29.60WQ30.61WB31.62WK32.63WR<><>"
    ).value().value
};
inline const auto DEFAULT_CHESS_BOARD_NIDW{
    from_string<board_repr::BoardRepr>{}(
        "02H8W8FWC0,7,25,32!"
        "0.00WR1.01WK2.02WB3.03WQ4.04WK5.05WB6.06WK7.07WR8.08WP9.09WP10.10WP11.11WP12.12WP13.13WP14.14WP15.15WP16.48BP17.49BP18.50BP19.51BP20.52BP21.53BP22.54BP23.55BP25.56BR26.57BK27.58BB28.59BQ29.60BK30.61BB31.62BK32.63BR<><>"
    ).value().value
};
