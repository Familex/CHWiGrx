...
public:
    ...
    std::vector<MoveRec> get_past() const { return prev_moves; }
    std::vector<MoveRec> get_future() const { return future_moves; }
    ...
    bool is_fifty_move_rule_was_triggered() const;
    bool is_moves_repeat_rule_was_triggered() const;
private:
