...
public:
    ...
    FV add(const mvmsg::MoveMessage& move_rec) noexcept -> void
    {
    ...
    FN prev_empty() const noexcept -> bool { return prev_.empty(); }

    FN future_empty() const noexcept -> bool { return future_.empty(); }
